...
export default function DcaCreation({ isExpanded, toggleScreen }) {
    ...
    function sortTokens(sortBy, sortOrder) {
        ...
        if (sortBy === 'name') {
            ...
            sortedTokens = sortedTokens.sort((a, b) =>
                sortedconfig.sortOrder === 0 ? a.volume_change_24h - b.volume_change_24h : b.volume_change_24h - a.volume_change_24h
            );
    ...
    const handleSelectToken = (type = 'buy') => {
        ...
        if (type == 'sell') {
            let _filteredCoinList = assets?.user_wallet_coins.filter(
                (e) =>
                    e.coin_symbol == 'DAI' || e.coin_symbol == 'USDC' || e.coin_symbol == 'USDT' || e.coin_symbol == 'TUSD' || e.coin_symbol == 'BUSD'
            );
    ...
    const tokenSelected = (e, i) => {
        ...
        if (type == 'buy') {
            ...
            setDcaData({
                ...dcaData,
                sellToken: {
                    quantity: e.coin_quantity,
                    symbol: e.coin_symbol,
                    address: e.coin_address,
                    url: e.coin_Logo,
                    coinDecimals: e?.coin_decimal,
                },
            });
        }
                                    ...
                                    <div className="monthDate">
                                        ...
                                        <div className="localTimeInputs">
                                            <input
                                                ...
                                                onChange={(val) =>
                                                    setDcaData({ ...dcaData, monthDay: Math.min(28, Math.max(1, validateInput(val.target.value))) })
                                                }
                                            />
                                        </div>
                                    </div>
                            ...
                            <div className="localTime">
                                ...
                                <div className="localTimeInputs">
                                    <input
                                        ...
                                        max={24}
                                        value={Hours}
                                        onChange={(input) => setHours(validateInput(input.target.value))}
                                    />
                                    <p className="localTime_seprator">:</p>
                                    <input
                                        type="Number"
                                        ...
                                        max={59}
                                        value={Minutes}
                                        onChange={(input) => setMinutes(validateInput(input.target.value))}
                                    />
                                </div>
                            </div>
                            {
                                <p className="smallTimeLine">
                                    The 1st purchase will begin on {formatDate(dcaData.startDate)} at{' '}
                      ...
                      <p>{e?.coinSymbol}</p>
                                ...
                                <svg xmlns="http://www.w3.org/2000/svg" width="6" height="6" viewBox="0 0 6 6" fill="none">
                                    ...
                                    <p>
                                        ...
                                        from <span>{formatDate(dcaData.startTime)}</span>, We will purchase <span> {dcaData.buyToken?.symbol}</span>{' '}
                                        worth{' '}
                                        <span>
                    ...
                    <div className="actions">
                      ...
                      <h2>{type == "sell" ? "Quantity" : "Price"}</h2> */}
                                            ...
                                            <h2
                                                ...
                                                className={
                                                    sortedconfig.sortBy == 'name' ? (sortedconfig.sortOrder == 1 ? 'active up' : 'active down') : ''
                                                }
                                            >
                                                Tokens{' '}
                                                <img
                                            ...
                                            {type == 'sell' ? (
                                                <h2
                                                    ...
                                                    className={
                                                        sortedconfig.sortBy == 'quantity'
                                                            ? sortedconfig.sortOrder == 1
                                                                ? 'active up'
                                                                : 'active down'
                                                            : ''
                                                    }
                                                ...
                                                filteredTokens.map((e, i) => {
                                                    return (
                                                        <div
                                                            ...
                                                            className={`token ${validateTokenSelection(e) ? 'active' : ''} ${
                                                                selectedTokens.length == 12 ? 'disabled' : ''
                                                        ...
                                                        >
                                                            <div className="token__info">
                                                                <div className="logos">
                                                                    ...
                                                                    <img
                                                                        src={getNetworkById(e?.coinChainID)?.networkLogo || getNetworkById(chainLogo)}
                                                                        className="chainLogo"
                                                                        alt=""
                                                                    />
                                                                </div>
                                                            ...
                                                            <div className="priceAndSelected">
                                                                <h3 className="price">
                                                                    ${formatDecimalValue(e?.volume_change_24h || e?.coin_price)}
                                                                </h3>
                                    ...
                                    {type == 'buy' && (
                                        <div className="searchBox">
                                            ...
                                            <input
                                                ...
                                                onChange={(e) => updateFilteredTokens(e.target.value)}
                                            />
                                        </div>
                                    )}
                        ...
                        {
                            <CombinedModal
                                show={transactionProgressModal}
                                overflow={true}
                                setShow={setTransactionProgressModal}
