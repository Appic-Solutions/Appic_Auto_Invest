export const idlFactory = ({ IDL }) => {
  ...
  return IDL.Service({
    ...
    addLiquidity: IDL.Func([IDL.Principal, IDL.Principal, IDL.Nat, IDL.Nat, IDL.Nat, IDL.Nat, IDL.Int], [TxReceipt], []),
    addLiquidityForUser: IDL.Func([IDL.Principal, IDL.Principal, IDL.Principal, IDL.Nat, IDL.Nat, IDL.Bool], [TxReceipt], []),
    addLiquidityForUserTest: IDL.Func([IDL.Principal, IDL.Principal, IDL.Principal, IDL.Nat, IDL.Nat], [IDL.Text], []),
    addNatLabsToken: IDL.Func([IDL.Text], [IDL.Bool], []),
    addToken: IDL.Func([IDL.Principal, IDL.Text], [TxReceipt], []),
    addTokenToBlocklist: IDL.Func([IDL.Principal, TokenBlockType], [IDL.Bool], []),
    addTokenToBlocklistValidate: IDL.Func([IDL.Principal, TokenBlockType], [ValidateFunctionReturnType], []),
    addTokenValidate: IDL.Func([IDL.Principal, IDL.Text], [ValidateFunctionReturnType], []),
    ...
    exportFaileWithdraws: IDL.Func([], [IDL.Vec(IDL.Tuple(IDL.Text, WithdrawState))], ["query"]),
    exportLPTokens: IDL.Func([], [IDL.Vec(TokenInfoExt)], ["query"]),
    exportPairs: IDL.Func([], [IDL.Vec(PairInfoExt)], ["query"]),
    exportRewardInfo: IDL.Func([], [IDL.Vec(IDL.Tuple(IDL.Principal, IDL.Vec(RewardInfo)))], ["query"]),
    exportRewardPairs: IDL.Func([], [IDL.Vec(PairInfoExt)], ["query"]),
    exportSubAccounts: IDL.Func([], [IDL.Vec(IDL.Tuple(IDL.Principal, DepositSubAccounts))], ["query"]),
    ...
    getAuthList: IDL.Func([], [IDL.Vec(IDL.Tuple(IDL.Principal, IDL.Bool))], ["query"]),
    ...
    getLastTransactionOutAmount: IDL.Func([], [SwapLastTransaction], ["query"]),
    getNatLabsToken: IDL.Func([], [IDL.Vec(IDL.Tuple(IDL.Text, IDL.Bool))], []),
    ...
    getUserInfoByNamePageAbove: IDL.Func([IDL.Principal, IDL.Int, IDL.Text, IDL.Nat, IDL.Nat, IDL.Int, IDL.Text, IDL.Nat, IDL.Nat], [UserInfoPage], ["query"]),
    ...
    getUserReward: IDL.Func([IDL.Principal, IDL.Text, IDL.Text], [Result_1], ["query"]),
    ...
    removeLiquidity: IDL.Func([IDL.Principal, IDL.Principal, IDL.Nat, IDL.Nat, IDL.Nat, IDL.Principal, IDL.Int], [TxReceipt], []),
    removeNatLabsToken: IDL.Func([IDL.Text], [IDL.Bool], []),
    removeTokenFromBlocklist: IDL.Func([IDL.Principal], [IDL.Bool], []),
    removeTokenFromBlocklistValidate: IDL.Func([IDL.Principal], [ValidateFunctionReturnType], []),
    removeUserFromBlocklist: IDL.Func([IDL.Principal], [IDL.Bool], []),
    retryDeposit: IDL.Func([IDL.Principal], [TxReceipt], []),
    retryDepositTo: IDL.Func([IDL.Principal, IDL.Principal, IDL.Nat], [TxReceipt], []),
    ...
    setMaxTokenValidate: IDL.Func([IDL.Nat], [ValidateFunctionReturnType], []),
    ...
    updateTokenTypeValidate: IDL.Func([IDL.Principal, IDL.Text], [ValidateFunctionReturnType], []),
