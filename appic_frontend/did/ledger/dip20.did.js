export const dip20IdleFactory = ({ IDL }) => {
  ...
  return IDL.Service({
    ...
    filterAllowancesArray: IDL.Func([IDL.Int], [IDL.Vec(IDL.Tuple(IDL.Principal, IDL.Vec(IDL.Tuple(IDL.Principal, IDL.Tuple(IDL.Nat, IDL.Int)))))], []),
    getASize: IDL.Func([], [IDL.Nat], ["query"]),
    getAgeAllowanceLimit: IDL.Func([], [IDL.Int], []),
    getAllowanceSize: IDL.Func([], [IDL.Nat], ["query"]),
    getAllowancesArray: IDL.Func([], [IDL.Vec(IDL.Tuple(IDL.Principal, IDL.Vec(IDL.Tuple(IDL.Principal, IDL.Tuple(IDL.Nat, IDL.Int)))))], []),
